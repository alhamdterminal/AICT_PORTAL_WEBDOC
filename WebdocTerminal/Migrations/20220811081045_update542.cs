...
{
    public partial class update542 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "EDI_Maersk_APIResponse",
                columns: table => new
                {
                    EDI_Maersk_APIResponseId = table.Column<long>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EDI_Maersk_APIResponse", x => x.EDI_Maersk_APIResponseId);
                });

            migrationBuilder.CreateTable(
                name: "EDI_Maersk_Lookup",
                columns: table => new
                {
                    EDI_Maersk_LookupId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EDI_Maersk_Lookup", x => x.EDI_Maersk_LookupId);
                });

            migrationBuilder.CreateTable(
                name: "EDI_Maersk_Message",
                columns: table => new
                {
                    EDI_Maersk_MessageId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EDI_Maersk_Message", x => x.EDI_Maersk_MessageId);
                });
        }
