    ...
    function listGrid(virno, containerno, indexno, agent, goodhead , type, fromdate, todate) {
    ...
    loadingBar();
    $.get('/APICalls/GetAICTAndLineIndexTariffRates?virno=' + virno + '&containerno=' + containerno + '&indexno=' + indexno + '&agent=' + agent + '&goodhead=' + goodhead + '&type=' + type + '&from=' + fromdate + '&to=' + todate  , function (data) {
        loadingBarHide();
    if (data) {
    ...
    autoFilterEnabled: true,
        ...
        workbook.xlsx.writeBuffer().then((buffer) => {
            ...
            if (griddata.length) {
                ...
                resffandContainerno = griddata[0].containerNumber + "-" + griddata[0].shippingAgentName + ".xlsx";
            }
    ...
    {
        dataField: "cfsContainerGateInDate",
    caption: "Arrival",
    allowEditing: false,
    dataType: 'date',
    format: 'dd/MM/yyyy',
        ...
        },
        {
            ...
            calculateCellValue: function (rowData) {
                ...
                var calculatedvalue = (rowData.aictPerIndexRate != null ? Number(rowData.aictPerIndexRate) : Number(0))
                    ...
                    +
                    (rowData.perBoxRate != null ? Number(rowData.perBoxRate) : Number(0))
    ...
    if (newresult.length) {
        ...
        console.log("ok newresult", newresult)
                ...
                newresult.forEach(c => {
                    ...
                    if ($.isNumeric(c.perBoxRate) == false) {
        resultvalue = false;
    ...
    var totalindx = Number(c.additionalChargeAICTPerIndexRate) + Number(c.additionalChargeFFPerIndexRate) + Number(c.aictPerIndexRate) + Number(c.ffPerIndexRate) + Number(c.perBoxRate);
