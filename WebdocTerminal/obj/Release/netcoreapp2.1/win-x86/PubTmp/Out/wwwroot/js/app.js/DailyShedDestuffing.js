    ...
    loadingBar();
    $.get('/Import/Reports/ViewDailyShedDestuffing?fromdate=' + fromdate + '&' + 'todate=' + todate + '&' + 'shippingagent=' + ShippingAgent + '&commodity=' + commodity, function (data) {
        loadingBarHide();
    $('#repotdata').html(data);
        });
    ...
    function formfiled() {
        ...
        if (PermissionInputs.find(x => x.fieldName == "goodshead" && x.isChecked == false)) {
