    ...
    checkColumn(e, "handlingCode");
        ...
        if (PermissionInputs.find(x => x.fieldName == "IsChecked" && x.isChecked == false)) {
    ...
    function loadGrid(dataSource) {
        ...
        $.get('/APICalls/GetCYWeightmentContainers', function (data) {
            console.log(data);
            if (dataSource)
    ...
    $.post('SaveCFSWeighmentContainers', {containers: weightmentContainers }, function (data) {
        ...
        showToast("CY Weighment Created", "success");
