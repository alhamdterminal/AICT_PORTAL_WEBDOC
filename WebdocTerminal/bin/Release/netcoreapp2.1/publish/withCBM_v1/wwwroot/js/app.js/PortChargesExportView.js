    ...
    function filterGrid( ) {
        ...
        var gdnumber = $("#gdnumberlist").dxAutocomplete("instance").option("value");

    $.get('/APICalls/GetPortChargesDetail?gdnumber=' + gdnumber , function (data) {

            if (data) {

        containerIndexesGrid(data)
    }

    else {
        containerIndexesGrid([]);
    ...
    if (resultvalue == true) {
        $.post('/Import/Setup/AddPortChargesList', { data: rowObject }, function (data) {
            ...
            if (data.error == true) {
                ...
                var virno = $("#gdnumberlist").dxAutocomplete("instance").option("value");
