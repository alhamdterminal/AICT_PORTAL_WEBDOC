    ...
    function getChequeType() {
        $.get('/Import/PartyLedger/GetLastChequeReceiveType', function (data) {
            type = data;
        });
    }
    ...
    $.post('/Import/PartyLedger/AddAmountReceived?' + values + '&type=' + type, function (res) {
    ...
    $.get('/APICalls/GetBalanceLedgerAmountByPartyId?partyId=' + partyId, function (data) {
