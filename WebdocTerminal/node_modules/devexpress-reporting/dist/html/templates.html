...
<script type="text/html" id="dxrd-multivalue">
    ...
    <div data-bind="dxTagBox: $parent.getOptions({ dataSource: $data.dataSource, searchEnabled: true, searchExpr: $data.searchExpr || ['displayValue'], value: $data.value,
         ...
         placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), maxDisplayedTags: $data.maxDisplayedTags }), dxValidator: { validationRules: $parent.validationRules || [] }">
    </div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-multivalue-selectbox">
    ...
    <div data-bind="dxSelectBox: $parent.getOptions({ dataSource: dataSource, itemTemplate: 'valueItem', onOptionChanged: onOptionChanged, value: editorValue, displayExpr: function() { return selectedValuesString(); } })">
        <div class="dxrd-multivalue-editor-item" data-options="dxTemplate: { name: 'valueItem' }" data-bind="dxclick: function(_, event) { toggleSelected(); event.stopPropagation(); }">
...
<script type="text/html" id="dxcd-collection-lookup-header">
    <div data-bind="dxSelectBox: { items: array, displayExpr: 'name', value: selectedItem, disabled: disabled,  placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), noDataText: $root.dx.Analytics.Internal.noDataText() }"></div>
</script>
    ...
    <div class="dxcd-summary-function-content">
        ...
        <div class="dx-field dxd-back-primary">
            ...
            <div class="dx-field-value">
                <div data-bind="dxSelectBox: { value: functionName, dataSource: $parent.availableItems() ,acceptCustomValue: true, disabled: $parent.disabled(), placeholder: $root.dx.Analytics.Internal.selectPlaceholder() }"></div>
            </div>
        </div>
        <!-- ko foreach: args -->
...
<script type="text/html" id="dxrd-menubutton-template">
    <div class="dxrd-menu-container dxrd-menu-fullscreen-nav" style="" data-bind="css: { 'dxrd-menu-fullscreen-nav-collapsed': isMenuCollapsed()}"></div>
    <div class="dxrd-menu-button dxd-toolbox-back-color dxd-border-primary dxd-back-primary2">
        ...
        <div class="dxd-menu-back-color dxd-back-contrast" data-bind="dxPopup: {
                             width: ko.computed(function() { return $data.isMenuCollapsed() ? 50 : 300}),
                             height: '100%',
                             position: $data.rtl ? { my: 'right top' , at: 'right top'  } : { my: 'left top' , at: 'left top' },
                             showTitle: false,
                             showCloseButton: false,
                             container: getMenuPopupContainer($element),
                             target: getMenuPopupTarget($element),
                             animation: {},
                             closeOnOutsideClick: !$data.isMenuCollapsed(),
                             shading: false,
...
<script type="text/html" id="dxrd-checkbox-style-combobox">
    <div data-bind="dxLocalizedSelectBox: { dataSource: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled }, dxValidator: { validationRules: $data.validationRules || [] }">
...
<script type="text/html" id="dxrd-style">
    <div data-bind="dxSelectBox: new $root.dx.Reporting.Designer.Widgets.StylesEditorHeaderModel(value, $root.styles(), disabled)"></div>
</script>
...
<script type="text/html" id="dxrd-scriptsbox">
    <div data-bind="dxEventDropDownEditor: { items: $root.events, value: value, editEnabled: true, disabled: disabled, secondAction: function() { $root.gotoEvent && $root.gotoEvent($data.value(), name, $parents[1]._model && $parents[1]._model()); }, placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), noDataText: $root.dx.Analytics.Internal.noDataText() }"></div>
</script>
...
<div class="dxrd-wizard-page dxrd-wizard-columns-page">
    ...
    <div class="dxrd-wizard-splitter">
        ...
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: selectAll, disabled: !isSelectEnable(), icon: 'dxrd-svg-operations-moveleft_all', iconClass: 'dxrd-image-moveright-all' }"></div>
            ...
            <div class="dxrd-wizard-customizelabel-head-props">
                <div class="dxrd-wizard-customizelabel-select-papersize">
                    ...
                    <div data-bind="dxSelectBox: { items: labelData.paperKinds, displayExpr: 'name', value: selectedPaperSize, itemTemplate: 'PaperSizeText',
                        ...
                        }}, attr: { title: selectedPaperSize().name + ' - ' + $root.dx.Reporting.Designer.Wizard.CustomizeLabelPage.getPageSizeText(selectedPaperSize().width, selectedPaperSize().height, selectedPaperSize().unit)}">
                        <div data-options="dxTemplate: { name: 'PaperSizeText' }" class="dxrd-wizard-customizelabel-select-customtemplate">
                            <p class="dxrd-wizard-customizelabel-select-template">
                                ...
                                <span data-bind="text: $root.dx.Reporting.Designer.Wizard.CustomizeLabelPage.getPageSizeText(width, height, unit)"></span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="dxrd-wizard-customizelabel-props-container">
                <div class="dxrd-wizard-customizelabel-props">
                    <div class="dxrd-wizard-customizelabel-pagesizetext-inline">
                        ...
                        <div data-bind="dxLocalizedSelectBox: { items: units, valueExpr: 'value', displayExpr: 'text', value: unit }"></div>
                    </div>
                    <div>
...
<script type="text/html" id="dxrd-page-masterdetail-groups-section">
    <div class="dxrd-wizard-page dxrd-wizard-masterdetail-groups-page dxd-border-secondary">
        <div class="dxrd-wizard-masterdetail-groups-page-section-content" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
            <div class="dx-fieldset" data-bind="foreach: groupInfos">
                <div class="dx-field dxd-back-primary">
    ...
    <div class="dxrd-wizard-masterdetail-groups-page-content">
        <div class="dxrd-wizard-left-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                <!-- ko if: $data.currentFields() -->
                <div class="dxrd-wizard-list" data-bind="dxList: { items: currentFields().items, selectedItems: currentFields().activeItemArray, height: '100%', selectionMode: 'single', activeStateEnabled: false, onItemClick: fieldClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
                    <div data-options="dxTemplate : { name: 'item' }" data-bind="event: { dblclick: $parent.fieldDblClick }">
                        <div data-bind="text: $data"></div>
                    </div>
                </div>
        ...
        <div class="dxrd-wizard-right-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                <!-- ko if: $data.currentGroups() -->
                <div class="dxrd-wizard-list" data-bind="dxList: { items: currentGroups().items, height: '100%', selectionMode: 'single', selectedItems: currentGroups().activeItemArray, activeStateEnabled: false, onItemClick: groupClick, noDataText: $root.dx.Analytics.Internal.noDataText() }">
                    <div data-options="dxTemplate : { name: 'item' }" data-bind="event: { dblclick: $parent.groupDblClick }">
                        <div data-bind="text: fields().join(', ')"></div>
                    </div>
                </div>
...
<script id="dxrd-page-masterdetail-select-reportdata-dataMembers" type="text/html">
    <div class="dxrd-wizard-reportdata-column dx-first-column">
        <div class="dxrd-wizard-reportdata-title" data-bind="text: selectDataMembersCaption"></div>
            ...
            <div class="dxrd-wizard-list-container">
                <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
                    <div class="dxrd-wizard-summary-infos dxrd-wizard-summary-infos-paragraf dxd-border-secondary">
                        <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: fieldsCaption, attr:{'title': fieldsCaption }"></div>
                        <div class="dxrd-wizard-summary-infos-summaries dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: summaryFunctionCaption, attr:{'title': summaryFunctionCaption }"></div>
                    ...
                    <div data-bind="foreach: summaryInfos">
                        <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                            <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                                <div data-bind="dxFieldListPicker: {
                                     itemsProvider: $parent.fieldListProvider,
...
<div class="dxrd-wizard-page dxrd-wizard-masterdetail-summary-options-page">
    ...
    <div class="dxrd-wizard-masterdetail-summary-options-content">
        ...
        <div class="dxrd-wizard-list-container">
            <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
                <div class="dxrd-wizard-summary-infos dxrd-wizard-summary-infos-paragraf dxd-border-secondary">
                    <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: fieldsCaption"></div>
                    <div class="dxrd-wizard-summary-infos-summaries dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: summaryFunctionCaption"></div>
                    <div class="dxrd-wizard-summary-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary"></div>
                </div>
                <div data-bind="foreach: summaryInfos">
                    <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                        <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                            <div data-bind="dxSelectBox: { dataSource: $parent.displayedFields[$parent.currentPath()], itemTemplate: 'visibleItems', displayExpr: 'displayName', value: field, placeholder: $root.dx.Analytics.Internal.selectPlaceholder() }">
...
<script type="text/html" id="dxrd-page-setup-page-preview">
    <div class="dxrd-wizard-preview dxd-back-secondary">
        <div style="width:100%; height:100%; position:relative">
            <div class="dxrd-wizard-preview-page" data-bind="style: { width: $data.previewPageWidth() + '%', height: $data.previewPageHeight() + '%' }">
                <div class="dxrd-wizard-preview-margin-top" data-bind="style: { top: $data.previewTopMargin() + '%' }"></div>
                <div class="dxrd-wizard-preview-margin-right" data-bind="style: { right: $data.previewRightMargin() + '%' }"></div>
                <div class="dxrd-wizard-preview-margin-bottom" data-bind="style: { bottom: $data.previewBottomMargin() + '%' }"></div>
                <div class="dxrd-wizard-preview-margin-left" data-bind="style: { left: $data.previewLeftMargin() + '%' }"></div>
            </div>
        </div>
    </div>
</script>
        ...
        <div class="dxrd-page-setup-setting">
            <div class="dx-fieldset dxrd-group-fieldset dxrd-page-setup-short-group">
                ...
                <div class="dx-field dxrd-page-setup-pagemode-compact">
                    ...
                    <div class="dx-field-value" data-bind="dxLocalizedSelectBox: { items: [ { value: true, displayName: 'Landscape', localizationId: 'ASPxReportsStringId.ReportDesigner_Wizard_ReportLayout_Landscape'}, { value: false, displayName: 'Portrait', localizationId:'ASPxReportsStringId.ReportDesigner_Wizard_ReportLayout_Portrait' }], valueExpr: 'value', displayExpr: 'displayName', value: $data.landscape }"></div>
                </div>
                <div class="dx-field">
...
<script type="text/html" id="dxrd-page-pageSetupAndColorScheme">
    <div class="dxrd-wizard-page dxrd-page-setup-page">
        <div class="dxrd-page-setup-content">
            <!-- ko template: { name: 'dxrd-page-setup-groups', data: $data.configureReportPageSettingsPage }-->
            <!-- /ko -->
            <!-- ko if: $data.colorSchemePageVisible -->
            <div class="dxrd-page-setup-group dxrd-page-color-setup-group">
                ...
                <div class="dxrd-page-setup-setting">
                    <!-- ko template: { name: 'dxrd-page-colorScheme-content', data: $data.colorSchemePage } -->
                    <!-- /ko -->
                </div>
            </div>
            <!-- /ko -->
    ...
    <div class="dxrd-wizard-preview dxd-back-secondary">
        <div style="width:100%; height:100%; position:relative">
            <div class="dxrd-wizard-preview-page" data-bind="style: { width: $data.previewPageWidth() + '%', height: $data.previewPageHeight() + '%' }">
                ...
                <div class="dxrd-wizard-preview-margin-bottom" data-bind="style: { bottom: $data.previewBottomMargin() + '%' }"></div>
                <div class="dxrd-wizard-preview-margin-left" data-bind="style: { left: $data.previewLeftMargin() + '%' }"></div>
                <div data-bind="style: { top: $data.previewTopMargin() + '%',  right: $data.previewRightMargin() + '%',  bottom: $data.previewBottomMargin() + '%', left: $data.previewLeftMargin() + '%' }">
                    <div class="dxrd-wizard-rows-container">
                        <!-- ko foreach: masterDetailInfo -->
                        <div class="dxrd-wizard-preview-row">
                            <!-- ko foreach: fields -->
                            <div class="dxrd-wizard-preview-column" data-bind="style: {  backgroundColor: $parents[1].color, width: 100/$parent.fields.length + '%', color: $parents[1].foreColor }, text: displayName"></div>
                            <!-- /ko -->
                        </div>
                        <div class="dxrd-wizard-preview-row">
                            <!-- ko foreach: fields -->
                ...
                <!-- ko if: $data.reportTitleVisible -->
                <div data-bind="dxTextBox: { value: reportTitle, placeholder: reportTitlePlaceholder() }, style: { top: $data.previewTopMargin() + '%', right: $data.previewRightMargin() + '%', left: $data.previewLeftMargin() + '%' }"></div>
                <!-- /ko -->
            </div>
        </div>
    </div>
