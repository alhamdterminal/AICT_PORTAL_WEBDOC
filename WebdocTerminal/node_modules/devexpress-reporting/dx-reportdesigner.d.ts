    ...
    module Widgets {
        module Internal {
            ...
            class TreeListRootItemViewModel extends TreeListItemViewModel {
                ...
                constructor(options: ITreeListOptions, path?: string[], onItemsVisibilityChanged?: () => any, rtl?: boolean);
            }
...
declare module DevExpress.Analytics {
    ...
    module Internal {
        ...
        class JSDesignerBindingCommon<T> {
    ...
    module Internal {
        ...
        function processErrorEvent(func: any): void;
...
declare module DevExpress {
    module Analytics {
        module Data {
            ...
            class JsonDataSource extends Analytics.Utils.Disposable {
                getInfo(): Analytics.Utils.ISerializationInfoArray;
            ...
            class SqlDataSource extends Analytics.Utils.Disposable {
                getInfo(): Analytics.Utils.ISerializationInfoArray;
        ...
        module Wizard {
            ...
            class WrappedWizardPage extends Utils.Disposable {
                pageId: string;
                page: IWizardPage;
                template: string;
                description?: string;
            ...
            class ChooseAvailableItemPage extends WizardPageBase {
                ...
                getSelectedItem(state?: any): Analytics.Internal.IDataSourceInfo;
            ...
            class ChooseJsonConnectionPage extends ChooseAvailableItemPage {
                ...
                getSelectedItem(data: IJsonDataSourceConnectionPageState): Analytics.Internal.IDataSourceInfo;
                readonly createNewOperationText: any;
                readonly existingOperationText: any;
            }
            ...
            class FullscreenWizardPage extends Analytics.Wizard.WizardPageBase {
                ...
                events: Utils.EventManager<Internal.WizardPageProcessor, IWizardFullscreenPageEvents<Internal.WizardPageProcessor>>;
            }
            ...
            module Internal {
                ...
                class JsonDataSourceJsonSourcePageStringSettings extends Utils.Disposable implements IJsonDataSourceJsonSourcePageSettings {
                ...
                class JsonDataSourceJsonSourcePageUriSettings extends Utils.Disposable implements IJsonDataSourceJsonSourcePageSettings {
                    private _requestWrapper;
                    dispose(): void;
                    onChange(_onChange: () => void): any;
                    private _isUriValid;
    ...
    module QueryBuilder {
        ...
        module Internal {
            ...
            class QueryBuilderTreeListController extends Analytics.Widgets.Internal.TreeListController {
                constructor(undoEngine: ko.Observable<Analytics.Utils.UndoEngine>, query: ko.Observable<Elements.QueryViewModel>, searchName: ko.Observable<string>);
...
declare module DevExpress.Reporting {
    ...
    module Viewer {
        ...
        module Internal {
            class PreviewDesignerActions implements Analytics.Internal.IActionsProvider {
            ...
            class PreviewActions implements Analytics.Internal.IActionsProvider {
                actions: Analytics.Utils.IAction[];
                constructor(reportPreview: ReportPreview);
                getActions(context: any): Analytics.Utils.IAction[];
            }
        ...
        module Internal {
            ...
            function createDesktopPreview(element: Element, callbacks: Utils.IPreviewCustomizationHandler, parametersInfo?: Parameters.IReportParametersInfo, handlerUri?: string, previewVisible?: boolean, applyBindings?: boolean, allowURLsWithJSContent?: boolean, rtl?: boolean, tabPanelSettings?: Utils.ITabPanelSettings): any;
        ...
        module Widgets {
            ...
            class MultiValueEditor extends Analytics.Widgets.Editor {
                private _createOptions;
                constructor(modelPropertyInfo: any, level: any, parentDisabled: any, textToSearch: any);
                options: ko.Observable<Internal.MultiValueEditorOptions>;
                value: ko.Computed<Parameters.MultiValuesHelper>;
            }
...
declare module DevExpress.Reporting {
        ...
        module Internal {
            ...
            module Series {
                ...
                class SeriesTemplateViewModel extends Analytics.Elements.SerializableModel {
                    ...
                    summaryFunction: Widgets.SummaryFunctionModel;
                }
    ...
    module Designer {
        ...
        module Internal {
            function registerControls(dataBindingMode?: string, fieldListProvider?: any): void;
        }
        module Utils {
            ...
            class ReportWizardSettings extends Analytics.Wizard.DataSourceWizardSettings implements IReportWizardSettings {
                createDefault(): IReportWizardSettings;
                useFullscreenWizard?: boolean;
                useMasterDetailWizard?: boolean;
            }
        ...
        module Widgets {
            ...
            class StylesEditorHeaderModel {
                ...
                constructor(styleName: ko.Observable<string>, styles: ko.ObservableArray<Controls.StyleModel>, disabled: ko.Observable<boolean>);
        ...
        module Controls {
            ...
            class ControlsFactory extends Analytics.Utils.ControlsFactory implements Analytics.Utils.IDisposable {
                ...
                constructor(bindingMode?: any, fieldListProvider?: ko.Observable | ko.Computed);
        ...
        module Internal {
            ...
            type WizardRunnerType = "NewReportViaWizard" | "AddMultiQuerySqlDataSource" | "ReportWizard";
            class WizardRunner extends Analytics.Utils.Disposable {
                ...
                registerWizard(wizardType: WizardRunnerType, start: () => void, close: () => void): void;
                runWizard(wizardType: WizardRunnerType): void;
            }
        ...
        module Wizard {
            module Legacy {
                class RequestReportModel {
                    ...
                    Unit: Designer.Internal.GraphicsUnit;
        ...
        module Internal {
            ...
            class ReportWizardService {
                static createWizardRequest(reportWizardModel: Wizard.Legacy.ReportWizardModel, state: any, oldReportJSON?: string): string;
                static createNewWizardRequest(reportWizardState: Wizard.IReportWizardState, requestType: any, state: any, oldReportJSON?: any): string;
                static generateReportFromWizardModel(reportWizardModel: Wizard.Legacy.ReportWizardModel, state: any, oldReportJSON?: string): any;
                static generateReportFromWizardState(reportWizardState: Wizard.IReportWizardState, requestType: any, state: any, oldReportJSON?: string): any;
        ...
        module Wizard {
            interface IReportWizardCallbacks extends Analytics.Wizard.IMultiQueryDataSourceWizardCallbacks {
        ...
        module Wizard {
            ...
            class PageSetupHelper {
                ...
                static getConverter(from: Designer.Internal.GraphicsUnit, to: Designer.Internal.GraphicsUnit): (val: number) => number;
            }
            enum ReportStyle {
                Bold = 0,
                Casual = 1,
        ...
        module Internal {
            ...
            function getFormattedValueInUnits(value: number, unit: Internal.GraphicsUnit): string;
            ...
            function createReportWizard(dsHelper: ko.Observable<DataSourceHelper> | ko.Computed<DataSourceHelper>, data: IReportWizardData, navigation: Tools.NavigateByReports, fieldLists: (IPathRequest: any) => JQueryPromise<DevExpress.Analytics.Utils.IDataMemberInfo[]>, isReportLoading: ko.Observable<boolean> | ko.Computed<boolean>, isReportDirty: ko.Observable<boolean> | ko.Computed<boolean>, state: () => {}, callBacks: Analytics.Wizard.IMultiQueryDataSourceWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, canCreateJsonDataSource: boolean): {
                registerWizardPages: (factory: Analytics.Wizard.PageFactory) => void;
                wizard: any;
            };
        ...
        module Wizard {
            module Legacy {
                class ReportWizardModel extends Analytics.Wizard.Legacy.MultiQueryDataSourceWizardModel {
                    ...
                    masterDetailInfoCollection: ko.ObservableArray<IMasterDetailQueryInfo>;
                    getOnlyCheckedQueries: (queries?: IMasterDetailQueryInfo[]) => IMasterDetailQueryInfo[];
                    initPageSetup: (model: Controls.ReportViewModel) => void;
                    reportTree: () => IMasterDetailReportTree[];
                    groups: string[][];
                    masterDetailGroups: {
                        [key: string]: any;
                    };
                ...
                class DataSourceWizard extends Analytics.Wizard.Legacy.WizardViewModel<ReportWizardModel> {
                    constructor(dataSources: ko.Observable<Analytics.Internal.IDataSourceInfo[]>, fieldListsCallback: IReportWizardFieldsCallback);
                    start(): void;
                    title: any;
                }
                ...
                class CustomizeLabelPage extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    unit: ko.Observable<Internal.GraphicsUnit>;
                    ...
                    static getPageSizeText(width: number, height: number, unit: Designer.Internal.GraphicsUnit): string;
                    units: {
                        text: any;
                        value: Internal.GraphicsUnit;
                    }[];
                ...
                class MasterDetailAddGroupingLevel extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    fieldCaption: any;
                    groupCaption: any;
                    reportTree: ko.ObservableArray<IMasterDetailReportTree>;
                }
                class MasterDetailChooseSummaryOptions extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    constructor(wizard: Analytics.Wizard.Legacy.WizardViewModel<ReportWizardModel>);
                    removeSummaryInfo(info: SummaryInfo): void;
                    toggleIgnoreNullValues: () => void;
                    _begin(data: ReportWizardModel): void;
                    commit(data: ReportWizardModel): void;
                    reset(): void;
                    ...
                    summaryInfos: ko.ObservableArray<SummaryInfo>;
                ...
                class PageSetupPage extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    unit: ko.Observable<Designer.Internal.GraphicsUnit> | ko.Computed<Designer.Internal.GraphicsUnit>;
                    width: ko.Observable<number> | ko.Computed<number>;
                    height: ko.Observable<number> | ko.Computed<number>;
                ...
                class SelectColumnsPage extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    private _selectedPath;
                    private _fields;
                    constructor(wizard: Analytics.Wizard.Legacy.WizardViewModel<ReportWizardModel>, getFieldListItems: IReportWizardFieldsCallback);
                    template: string;
                    description: any;
                ...
                class SelectDataMemberPage extends Analytics.Wizard.Legacy.WizardPage<ReportWizardModel> {
                    ...
                    private readonly dataSourcePath;
                    private _beginInternal;
                    constructor(wizard: Analytics.Wizard.Legacy.WizardViewModel<ReportWizardModel>, fieldListItemsCallback: IReportWizardFieldsCallback, createSqlDataSourceInfo: (dataSource: Analytics.Data.SqlDataSource) => JQueryPromise<Designer.Internal.IDataSourceInfo>, hideDataMemberSubItems?: boolean);
                    template: string;
                    description: any;
                    scrollViewHeight: string;
                    fieldListModel: {
                ...
                class ReportWizardAddQueriesPage extends Analytics.Wizard.Legacy.MultiQueryConfigurePage {
                    private _reportData;
                    constructor(wizard: Analytics.Wizard.Legacy.WizardViewModel<Analytics.Wizard.Legacy.MultiQueryDataSourceWizardModel>, callbacks: Analytics.Wizard.IDataSourceWizardCallbacks, disableCustomSql: boolean, rtl: boolean);
                    beginAsync(data: ReportWizardModel): JQueryPromise<any>;
                    commit(data: ReportWizardModel): void;
        ...
        module Bands {
            ...
            class DetailBandSurface extends BandSurface {
                constructor(band: DetailBand, context: Analytics.Elements.ISurfaceContext);
            ...
            class SubBandSurface extends BandSurface {
                ...
                constructor(band: SubBandViewModel, context: Analytics.Elements.ISurfaceContext);
                parent: BandSurface;
                leftMarginTemplate: string;
            }
        ...
        module Wizard {
            type WizardTypeString = "DataSourceWizard" | "MultiQueryDataSourceWizard" | "ReportWizard";
            type WizardType = Analytics.Wizard.DataSourceWizard | Analytics.Wizard.MultiQueryDataSourceWizard | Analytics.Wizard.DataSourceFullscreenWizard | Wizard.ReportWizard | Wizard.LegacyReportWizard | Wizard.FullscreenReportWizard;
        ...
        module Wizard {
            ...
            interface IPredefinedLabelState {
                labelDetails?: Wizard.ILabelDetails;
            }
            interface IDataSourceSettingsWizard extends Analytics.Wizard.IDataSourceWizardState {
                dataSource?: string;
                newDataSource?: string;
            }
            interface IDataMemberSettings {
                dataMember?: string;
                masterDetailInfoCollection?: Wizard.IMasterDetailQueryInfo[];
            }
            interface ILegacyReportWizardState {
                ...
                summaryOptions?: Array<Wizard.ISummaryOptions>;
                ignoreNullValuesForSummary?: boolean;
                fitFieldsToPage?: boolean;
                layout?: Wizard.ReportLayout;
                portrait?: boolean;
            ...
            interface IReportWizardState extends IReportTypeState, IPredefinedLabelState, IReportTitleState, IGroupingState, ISummaryState, IDataSourceSettingsWizard, IDataMemberSettings, ILegacyReportWizardState {
                pageSetup: Wizard.IPageSetup;
                colorScheme: IColorSchemeState;
            }
            var defaultPageSetupState: Wizard.IPageSetup;
            var defaultReportWizardState: IReportWizardState;
            function createReportWizardState(reportViewModel?: Controls.ReportViewModel): any;
            class ReportWizard extends DevExpress.Analytics.Wizard.PopupWizard {
                private _availableDataSources;
                private _connectionStrings;
                private _canEditSource;
                constructor(pageFactory: Analytics.Wizard.PageFactory, _availableDataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, _connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, _canEditSource?: boolean, finishCallback?: any);
                initialize(state?: any): void;
                start(finishCallback?: (state: IReportWizardState) => JQueryPromise<any>): void;
                requestModelType: typeof Internal.MasterDetailRequestModel;
                title: any;
            }
            class ReportWizardPageIterator extends DevExpress.Analytics.Wizard.MultiQueryDataSourceWizardPageIterator<IReportWizardState> {
                private _availableDataSources;
                constructor(pagesFactory: Analytics.Wizard.PageFactory, stateManager: Analytics.Wizard.StateManager, _availableDataSources?: any[], connectionStrings?: Analytics.Wizard.IDataSourceWizardConnectionStrings, canEditSource?: boolean);
                getNextPageId(pageId?: string): string;
            }
            function registerCommonReportWizardPages(factory: Analytics.Wizard.PageFactory, dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, wizardSettings: Utils.IReportWizardSettings, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, disableCustomSql?: boolean, canCreateNewJsonDataSource?: boolean): void;
            function registerReportWizardPages(factory: Analytics.Wizard.PageFactory, dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, wizardSettings: Utils.IReportWizardSettings, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean, canCreateJsonDataSource?: boolean): void;
            function createReportWizard(dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, wizardSettings: Utils.IReportWizardSettings, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean, canCreateJsonDataSource?: boolean): ReportWizard;
            class ChooseReportTypePageBase extends DevExpress.Analytics.Wizard.ChooseDataSourceTypePage {
                constructor(canCreateDatabound: any);
                addDataboundReportType(): void;
                canNext(): boolean;
                canFinish(): boolean;
                commit(): JQueryPromise<{}>;
                initialize(state: any): JQueryPromise<{}>;
                extendCssClass: (rightPath: any) => string;
            }
            class ChooseReportTypePage extends ChooseReportTypePageBase {
                addDataboundReportType(): void;
            }
            class ChooseDataSourceTypePage extends Analytics.Wizard.ChooseDataSourceTypePage {
                constructor(jsonAvailable: boolean);
            }
            function registerChooseReportTypePageBase(factory: DevExpress.Analytics.Wizard.PageFactory, useExtend: boolean, canCreateDatabound: boolean): void;
            function registerChooseDataSourceTypePage(factory: Analytics.Wizard.PageFactory, jsonAvailable: boolean): void;
            class CustomizeLabelPage extends DevExpress.Analytics.Wizard.WizardPageBase {
                ...
                labelsCountText: ko.PureComputed<string>;
                pageSizeText: ko.PureComputed<string>;
                static getPageSizeText(width: number, height: number, unit: Internal.GraphicsUnit): string;
                units: {
                    text: any;
                    value: Internal.GraphicsUnit;
                }[];
            }
            function registerCustomizeLabelPage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
        }
        module Internal {
        ...
        module Wizard {
            class SelectLabelTypePage extends DevExpress.Analytics.Wizard.WizardPageBase {
                constructor();
                initialize(state: IPredefinedLabelState): JQueryPromise<{
                    labelProducts: ILabelProduct[];
                    paperKinds: IPaperKind[];
                    labelDetails: ILabelDetails[];
                }>;
                canFinish(): boolean;
                commit(): JQueryPromise<IPredefinedLabelState>;
                selectedPaperSize: ko.Computed<IPaperKind>;
                labelData: {
                    labelProducts: Wizard.ILabelProduct[];
                    paperKinds: Wizard.IPaperKind[];
            ...
            function registerSelectLabelTypePage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
            function convertToStateDataSource(dataSource: any): string;
            function restoreDataSourceFromState(dataSource: any): any;
            class ChooseAvailableDataSourcePage extends Analytics.Wizard.ChooseAvailableItemPage {
                commit(): JQueryPromise<{}>;
                getSelectedItem(state: any): any;
                readonly createNewDataSourceOperationText: any;
            }
            function registerChooseAvailableDataSourcePage(factory: Analytics.Wizard.PageFactory, dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>): void;
            class SelectDataMembersPage extends Analytics.Wizard.WizardPageBase {
                ...
                canNext(): boolean;
                canFinish(): boolean;
                constructor(_fieldListCallBack: Wizard.IReportWizardFieldsCallback, _hideDataMemberSubItems?: boolean);
                dataMemberFieldListModel: Analytics.Widgets.Internal.ITreeListOptions;
                fieldMemberFieldListModel: Analytics.Widgets.Internal.ITreeListOptions;
                initialize(state: IReportWizardState): JQueryPromise<any>;
                haveCheckedFields(): boolean;
                commit(): JQueryPromise<{}>;
                showFirstLevelDataMembers: ko.Observable<boolean>;
            ...
            function registerSelectDataMembersPage(factory: Analytics.Wizard.PageFactory, callbacks: Wizard.IReportWizardCallbacks, hideDataMemberSubItems?: boolean): void;
            function fillTreeQueries(reportTree: any, queries: Wizard.IMasterDetailQueryInfo[], level: number, parentDisplayName?: string): any;
            class AddGroupingLevelPage extends Analytics.Wizard.WizardPageBase {
                ...
                commit(): JQueryPromise<{}>;
                currentPath: ko.Observable<string>;
                currentFields: ko.Observable<Internal.ListViewModel<string>>;
                currentGroups: ko.Observable<Internal.ListViewModel<{
                    fields: ko.ObservableArray<string>;
                }>>;
                fieldCaption: any;
                groupCaption: any;
                reportTree: ko.ObservableArray<Wizard.IMasterDetailReportTree>;
            }
            function registerAddGroupingLevelPage(factory: Analytics.Wizard.PageFactory): void;
            interface IGroupFieldDataMemberInfo extends Analytics.Utils.IDataMemberInfo {
                visible?: ko.Observable<boolean>;
            }
            class GroupsFieldStore extends Analytics.Utils.Disposable {
                private _onChange;
                dispose(): void;
                dataSource: ko.ObservableArray<IGroupFieldDataMemberInfo>;
                constructor(query: Wizard.IMasterDetailReportTree, _onChange: () => void);
                getSelectedFieldsFlat(): IGroupFieldDataMemberInfo[];
                getSelectedFields(): string[][];
                groups: ko.ObservableArray<GroupField>;
                isCreateGroupEnabled(): boolean;
                path: string;
                addGroupText: () => any;
                displayName: string;
            ...
            class GroupField extends Analytics.Utils.Disposable {
                private _store;
                private _onChange;
                private _updateDataSource;
                constructor(_store: GroupsFieldStore, _onChange: () => void);
                getOptions(): any;
                value: any;
                fields: ko.ObservableArray<string>;
            }
            class AddGroupingLevelSection extends Analytics.Wizard.WizardPageBase {
                dispose(): void;
                canFinish(): boolean;
                private _mergeGroups;
                initialize(state: IReportWizardState): JQueryPromise<{}>;
                commit(): JQueryPromise<{}>;
                reportTree: Wizard.IMasterDetailReportTree[];
                groupInfos: ko.ObservableArray<Wizard.GroupsFieldStore>;
            }
            function registerAddGroupingLevelSection(factory: Analytics.Wizard.PageFactory): void;
            class ChooseSummaryOptionsPage extends Analytics.Wizard.WizardPageBase {
                ...
                private _changeQuery;
                constructor();
                removeSummaryInfo(info: Wizard.SummaryInfo): void;
                canFinish(): boolean;
                toggleIgnoreNullValues: () => void;
                initialize(state: IReportWizardState): JQueryPromise<{}>;
                commit(): JQueryPromise<{}>;
            ...
            function registerChooseSummaryOptionsPage(factory: Analytics.Wizard.PageFactory): void;
            class ChooseSummaryOptionsSection extends Analytics.Wizard.WizardPageBase {
                dispose(): void;
                private _fillTreeQueries;
                private _createSummaryInfo;
                private _createNewItemIfNeed;
                ...
                private _flat;
                removeSummaryInfo(info: Wizard.SummaryInfoFieldlist): void;
                canFinish(): boolean;
                toggleIgnoreNullValues: () => void;
                _updateSummaries(flatlist: ISummaryDataMemberInfo[]): void;
                initialize(state: IReportWizardState): JQueryPromise<{}>;
                commit(): JQueryPromise<{}>;
                fieldListProvider: ko.Observable<Analytics.Utils.IItemsProvider>;
                ignoreNullValues: ko.Observable<boolean>;
                template: string;
                reportTree: ko.ObservableArray<Wizard.ISummaryDataMemberInfo>;
                availableFieldsCount: ko.Observable<number>;
                summaryInfos: ko.ObservableArray<SummaryInfoFieldlist>;
                selectFieldToSummaryCaption: any;
                fieldsCaption: any;
                summaryFunctionCaption: any;
                ignoreNullValuesCaption: any;
            }
            function registerChooseSummaryOptionsSection(factory: Analytics.Wizard.PageFactory): void;
            class ConfigureReportPageSettingsPage extends Analytics.Wizard.WizardPageBase {
                ...
                unit: ko.Computed<Designer.Internal.GraphicsUnit>;
                width: ko.Observable<number>;
                height: ko.Observable<number>;
                ...
                previewPageTop: ko.Computed<number>;
                previewPageLeft: ko.Computed<number>;
            ...
            function applySetting(data: Wizard.IPageSetup, state: Wizard.IPageSetup): void;
            function registerConfigureReportPageSettingsPage(factory: Analytics.Wizard.PageFactory): void;
            class ChooseReportColorSchemePage extends Analytics.Wizard.WizardPageBase {
                constructor();
                applyScheme(data: Wizard.ColorScheme): void;
                canFinish(): boolean;
                scheme: ko.Observable<Wizard.ColorScheme>;
                customColorScheme: CustomColorScheme;
                lookupData: {
                    scheme: ColorScheme[];
                };
            ...
            function applyColorSchemeState(data: IColorSchemeState, state: IColorSchemeState): void;
            function resetColorSchemeState(state: IColorSchemeState): void;
            function registerChooseReportColorSchemePage(factory: Analytics.Wizard.PageFactory): void;
            ...
            function registerSetReportTitlePage(factory: Analytics.Wizard.PageFactory): void;
            class ConfigureReportPageSettingsAndColorSchemeSection extends Analytics.Wizard.WizardPageBase {
                configureReportPageSettingsPage: ConfigureReportPageSettingsPage;
                colorSchemePage: ChooseReportColorSchemePage;
                colorSchemePageVisible: boolean;
                dispose(): void;
                onChange(callback: any): void;
                canNext(): boolean;
                canFinish(): boolean;
            ...
            function registerConfigureReportPageSettingsAndColorSchemeSection(factory: Analytics.Wizard.PageFactory): void;
        }
        module Internal {
        ...
        module Wizard {
            ...
            function registerChooseJsonSchemaPage(factory: Analytics.Wizard.PageFactory, callbacks: Wizard.IReportWizardCallbacks): void;
            ...
            function registerConfigureMasterDetailRelationshipsPage(factory: Analytics.Wizard.PageFactory, callbacks: Wizard.IReportWizardCallbacks): void;
            class MultiQueryConfigurePage extends Analytics.Wizard.MultiQueryConfigurePage {
                private _dataSourceWizardHelper;
                constructor(createSqlDataSourceInfo: (dataSource: Analytics.Data.SqlDataSource) => JQueryPromise<Designer.Internal.IDataSourceInfo>, callbacks: any, disableCustomSql: any, rtl: any, requestWrapper: any);
                getQueriesCount(): any;
                canEditQueryParameters(): any;
                initialize(state: any): JQueryPromise<Analytics.Data.Utils.ISqlQueryViewModel>;
                commit(): JQueryPromise<any>;
            }
            function registerMultiQueryConfigurePage(factory: Analytics.Wizard.PageFactory, callbacks: Wizard.IReportWizardCallbacks, disableCustomSql: boolean, rtl: boolean): void;
            ...
            function registerMultiQueryConfigureParametersPage(factory: Analytics.Wizard.PageFactory, callbacks: Wizard.IReportWizardCallbacks): void;
            ...
            function registerLegacyAddGroupingLevelPage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
            ...
            function registerLegacyChooseReportLayoutPage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
            ...
            function registerLegacyChooseReportStylePage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
            ...
            function registerLegacyChooseSummaryOptionsPage(factory: DevExpress.Analytics.Wizard.PageFactory): void;
            class LegacySelectColumnsPage extends DevExpress.Analytics.Wizard.WizardPageBase {
                private _fieldListsCallback;
                private _selectedPath;
                private _fields;
                constructor(getFieldListItems: Wizard.IReportWizardFieldsCallback);
                canFinish(): boolean;
                canNext(): boolean;
                selectedPath(): any;
                reset(): void;
            ...
            function registerLegacySelectColumnsPage(factory: DevExpress.Analytics.Wizard.PageFactory, fieldListItemsCallback: Wizard.IReportWizardFieldsCallback): void;
            class LegacyChooseDataMemberPage extends DevExpress.Analytics.Wizard.WizardPageBase {
                ...
                private readonly dataSourcePath;
                private _beginInternal;
                constructor(fieldListItemsCallback: Wizard.IReportWizardFieldsCallback, createSqlDataSourceInfo: (dataSource: Analytics.Data.SqlDataSource) => JQueryPromise<Designer.Internal.IDataSourceInfo>, hideDataMemberSubItems?: boolean);
                canNext(): boolean;
                canFinish(): boolean;
                initialize(state: IReportWizardState): JQueryPromise<any>;
                commit(): JQueryPromise<ILegacyReportWizardState>;
            ...
            function registerLegacyChooseDataMemberPage(factory: DevExpress.Analytics.Wizard.PageFactory, fieldListItemsCallback: Wizard.IReportWizardFieldsCallback, createSqlDataSourceInfo: (dataSource: Analytics.Data.SqlDataSource) => JQueryPromise<Designer.Internal.IDataSourceInfo>, hideDataMemberSubItems?: boolean): void;
            class LegacyReportWizard extends DevExpress.Analytics.Wizard.PopupWizard {
                private _connectionStrings;
                constructor(pageFactory: any, _connectionStrings: any, finishCallback?: any);
                initialize(state?: any): void;
                start(finishCallback?: (state: IReportWizardState) => JQueryPromise<any>): void;
                requestModelType: typeof Internal.LegacyReportRequestModel;
            }
            class LegacyReportWizardPageIterator extends Analytics.Wizard.MultiQueryDataSourceWizardPageIterator<IReportWizardState> {
                constructor(pageFactory: Analytics.Wizard.PageFactory, stateManager: Analytics.Wizard.StateManager, connectionStrings: any);
                getNextPageId(pageId: string): string;
            }
            function createLegacyReportWizard(dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, wizardSettings: Utils.IReportWizardSettings, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean): LegacyReportWizard;
            class SelectReportTypePage extends Analytics.Wizard.FullscreenWizardPage {
                private canCreateDatabound;
                constructor(canCreateDatabound: boolean);
                getNextPageId(pageId: any): string;
                registerPages(): void;
            }
            function registerSelectReportTypePage(factory: Analytics.Wizard.FullscreenWizardPageFactory, canCreateDatabound: boolean): void;
            class SelectDataSourcePage extends Analytics.Wizard.FullscreenWizardPage {
                dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>;
                private _connectionStrings;
                private _wizardSettings;
                private _canCreateNewJsonDataSource;
                constructor(dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, _connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, _wizardSettings: Analytics.Wizard.IDataSourceWizardSettings, _canCreateNewJsonDataSource: boolean);
                registerPages(): void;
                getNextPageId(pageId: any): string;
            }
            function registerSelectDataSourcePage(factory: Analytics.Wizard.FullscreenWizardPageFactory, dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, wizardSettings: Analytics.Wizard.IDataSourceWizardSettings, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, canCreateNewJsonDataSource: boolean): void;
            ...
            function registerSpecifySqlDataSourceSettingsPage(factory: Analytics.Wizard.FullscreenWizardPageFactory, connections?: Analytics.Wizard.IDataSourceWizardConnectionStrings, callbacks?: Wizard.IReportWizardCallbacks, requestWrapper?: QueryBuilder.Utils.RequestWrapper, disableCustomSql?: boolean): void;
            class SpecifyJsonDataSourceSettingsPage extends Analytics.Wizard.SpecifyJsonDataSourceSettingsPage {
                registerPages(): void;
                canNext(): boolean;
                _callbacks: IReportWizardCallbacks;
            }
            function registerSpecifyJsonDataSourceSettingsPage(factory: Analytics.Wizard.FullscreenWizardPageFactory, connections: Analytics.Wizard.IDataSourceWizardConnectionStrings, canCreateNewJsonDataSource: boolean, callbacks: IReportWizardCallbacks): void;
            class DefineReportLayoutPage extends Analytics.Wizard.FullscreenWizardPage {
                private callbacks;
                private hideDataMemberSubItems;
                constructor(callbacks: Wizard.IReportWizardCallbacks, hideDataMemberSubItems: boolean);
                registerPages(): void;
                beforeStart(): void;
                getNextPageId(pageId: string): string;
                showFirstLevelDataMembers: boolean;
            }
            function registerDefineReportLayoutPage(factory: Analytics.Wizard.FullscreenWizardPageFactory, callbacks: Wizard.IReportWizardCallbacks, hideDataMemberSubItems: boolean): void;
            ...
            function registerSpecifyPageSettingsPage(factory: Analytics.Wizard.FullscreenWizardPageFactory): void;
            class ColoredPageSettingPage extends ConfigureReportPageSettingsPage {
                constructor();
                private _getBrightness;
                private _fillTables;
                initialize(state: any): JQueryPromise<{}>;
                commit(): JQueryPromise<{}>;
                reportTitlePlaceholder(): any;
                foreColor: ko.Observable<string>;
                masterDetailInfo: ko.ObservableArray<any>;
                reportTitle: ko.Observable<string> | ko.Computed<string>;
                reportTitleVisible: boolean;
                color: ko.Observable<string>;
            }
            function registerColoredPageSettingPage(factory: Analytics.Wizard.PageFactory): void;
            ...
            function registerSpecifyLabelSettingsPage(factory: Analytics.Wizard.FullscreenWizardPageFactory): void;
            class FullscreenReportWizard extends Analytics.Wizard.FullscreenWizard {
                private _dataSources;
                callbacks: Wizard.IReportWizardCallbacks;
                connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings;
                disableCustomSql?: boolean;
                constructor(pageFactory: Analytics.Wizard.FullscreenWizardPageFactory, _dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean);
                description(): any;
                initialize(state?: any): void;
                requestModelType: typeof Internal.MasterDetailRequestModel;
                availableDataSources: ko.Observable<Analytics.Internal.IDataSourceInfo[]> | ko.Computed<Analytics.Internal.IDataSourceInfo[]>;
            }
            class FullscreenReportWizardPageIterator extends DevExpress.Analytics.Wizard.PageIterator<IReportWizardState> {
                getNextPageId(pageId?: string): string;
            }
            function registerFullscreenReportWizardPages(factory: Analytics.Wizard.PageFactory, dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, wizardSettings: Utils.IReportWizardSettings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean, canCreateNewJsonDataSource?: boolean): void;
            function createFullscreenReportWizard(dataSources: ko.Subscribable<Analytics.Internal.IDataSourceInfo[]>, callbacks: Wizard.IReportWizardCallbacks, connectionStrings: Analytics.Wizard.IDataSourceWizardConnectionStrings, wizardSettings: Utils.IReportWizardSettings, hideDataMemberSubItems?: boolean, disableCustomSql?: boolean, canCreateNewJsonDataSource?: boolean): FullscreenReportWizard;
        }
        module Widgets {
        ...
        module Tools {
            ...
            class NavigateByReports extends Analytics.Utils.Disposable {
                ...
                private _addTab;
                changeContext(report: Controls.ReportViewModel, reportUrl?: ko.Observable<any>, tab?: INavigateTab): void;
        ...
        module Internal {
            class ReportMenuSettings extends DevExpress.Analytics.Internal.MenuSettings {
                generate(): {};
                private _isMenuCollapsed;
                isMenuCollapsed: ko.Computed<boolean> | ko.Observable<boolean>;
            }
        }
        ...
        module Internal {
            ...
            class WizardsInitializerSettings {
                ...
                dataSourceWizard: Analytics.Wizard.DataSourceWizard;
                multiQueryDataSourceWizard: Analytics.Wizard.MultiQueryDataSourceWizard | Analytics.Wizard.DataSourceFullscreenWizard;
                multipleQueriesWizardCallbacks: Analytics.Wizard.IMultiQueryDataSourceWizardCallbacks;
                ...
                createMultiQueryDataSourceWizard(disableCustomSql: any, multipleQueriesWizardCallbacks?: Analytics.Wizard.IMultiQueryDataSourceWizardCallbacks, canCreateJsonDataSource?: boolean): void;
            ...
            class ReportDesignerInitializer extends Analytics.Internal.CommonDesignerGenerator<IReportDesignerRootContext> {
                ...
                addFlagsAndInitProperties(): this;
                ...
                registerControls(dataBindingMode: string, reportItemsProvider: ko.Observable<ReportItemsProvider> | ko.Computed<ReportItemsProvider>): this;
        ...
        class JSReportDesigner {
            ...
            RunWizard(wizardType: Internal.WizardRunnerType): void;
