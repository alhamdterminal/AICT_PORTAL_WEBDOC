...
<script type="text/html" id="dxrd-page-choose-datasource-type">
    <div class="dxrd-wizard-type-page" data-bind="css: $data.extendCssClass('type-page')">
        <!-- ko foreach: typeItems -->
        <div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected">
            <div data-bind="event: { click: $parent.itemClick }, attr: { class: 'dxrd-wizard-type-item dx-fontsize-reestablished dxrd-wizard-type-item-border-color dxd-list-item-back-color ' + $parent.extendCssClass('type-item')}, css: { 'dxd-state-selected dxd-border-secondary dxd-back-secondary': $parent.IsSelected($data) } ">
                <div data-bind="attr: { class: 'dxrd-wizard-type-image ' + $parent.extendCssClass('type-image') }, css: imageClassName, template: imageTemplateName"> </div>
                <div class="dxrd-wizard-type-text" data-bind="text: text, attr: { title: text }, css: $parent.extendCssClass('type-text')"></div>
            </div>
        </div>
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dx-wizard-fullscreen">
    ...
    <div class="dx-fullscreen-wizard dx-editors" data-bind="css: { 'dx-rtl': $root.rtl, 'dx-ltr': !$root.rtl }">
        <div class="dxrd-wizard dxrd-report-wizard dx-editors dxd-text-primary dxd-back-primary2" data-bind="css: extendCssClass">
            <div class="dxrd-wizard-steps-container dxd-back-primary" data-bind="visible: $data.navigationPanel().isVisible">
                <div class="dxrd-wizard-title dxd-border-primary" data-bind="text: description()"></div>
                <!-- ko with: navigationPanel -->
                <div class="dxrd-wizard-steps" data-bind="foreach: steps">
            ...
            <div class="dxrd-wizard-content" data-bind="css: { 'withoutPanel': !$data.navigationPanel().isVisible() }">
                <div class="dxrd-wizard-part-description dxd-back-contrast">
                    <div class="dxrd-wizard-part-description-text dxd-text-primary dxd-border-primary" data-bind="text: pageDescription()"></div>
                </div>
                <!-- ko with: currentPage -->
...
<script type="text/html" id="dx-wizard-fullscreen-page">
    <!-- ko if: $data.sections.length > 0 -->
    <div style="position:absolute;" data-bind="foreach: sections, styleunit: { top: parentMarginOffset, left: parentMarginOffset, right: parentMarginOffset, bottom: parentMarginOffset }">
        <div class="dx-border-inheritor dxd-border-accented">
            <div class="dxrd-report-page-tile dxd-border-secondary" data-bind="css: { 'dxrd-disabled': !$data.page() }, style: $parent.pageCss[$data.pageId]">
                <div class="dxrd-report-page-tile-title" data-bind="visible: $parent.isShowPageDescription(), text: $parent.getPageDescription($index(), $data), attr: { title: $parent.getPageDescription($index(), $data) }"></div>
...
<script type="text/html" id="dxrd-jsondatasource-fields-page">
    <div class="dxrd-wizard-page dx-jsonschema-page dx-frameless-style">
        <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-dataMember dx-fieldset" style="height:100%">
            <div class="dx-field">
                <div class="dx-field-label" data-bind="text: rootElementTitle"></div>
                <div class="dx-field-value" data-bind="dxSelectBox: { dataSource: rootElementList, value: selectedRootElement, displayExpr: 'fullPath', displayCustomValue: true }"></div>
            </div>
...
<script type="text/html" id="dxrd-page-jsonsource">
    <div class="dxrd-wizard-page dx-jsonsource-page dx-frameless-style">
        <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-dataMember dx-fieldset" style="height: 100%" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true }">
            <div class="dx-field">
                <div class="dx-field-label" data-bind="text: jsonConnectionTitle"></div>
                <div class="dx-field-value" data-bind="dxTextBox: { value: connectionName }"></div>
            </div>
            <div class="dx-field">
                <div class="dx-field-label" data-bind="text: jsonSourceTitle"></div>
                <div class="dx-field-value" data-bind="dxLocalizedSelectBox: { dataSource: sources, value: selectedSource, valueExpr:'value', displayExpr: 'displayValue', displayCustomValue: true }"></div>
            </div>
...
<div class="dxrd-wizard-page">
    ...
    <div class="dxrd-wizard-datasourceoperation" style="margin-bottom: 15px" data-bind="dxRadioGroup: { value: selectedDataSourceOperation, items: dataSourceOperations, layout: 'vertical' }">
...
<div class="dxrd-wizard-page">
    <!-- ko if: isNewCreationAvailable -->
    <div class="dxrd-wizard-datasourceoperation" style="margin-bottom: 15px" data-bind="dxRadioGroup: { value: selectedOperation, items: operations, layout: 'vertical' }">
        <div data-options="dxTemplate : { name: 'text' }">
            <div data-bind="text: $data"></div>
        </div>
    </div>
    <!-- /ko -->
    <div class="dxrd-wizard-availabledatasources dx-default-border-style dxd-border-secondary" data-bind="styleunit: { top: $data.isNewCreationAvailable() ? 65 : 0 }">
        <div class="dxrd-wizard-list" data-bind="dxList: { dataSource: items, selectedItems: selectedItems, focusStateEnabled:false, editEnabled: true, height: '100%', editConfig: { selectionEnabled: false }, selectionMode: 'single', activeStateEnabled: false, disabled: createNew, noDataText: $root.dx.Analytics.Internal.noDataText() }">
            <div data-options="dxTemplate : { name: 'item' }">
                <div data-bind="text: $parent.displayExpr($data)"></div>
            </div>
        </div>
    </div>
</div></script>
...
<script type="text/html" id="dx-jsonwizard-queryparameter">
    <div class="dx-field">
        <!-- ko with: value -->
        <div class="dx-jsonwizard-parameter-left-container">
            <div class="dx-jsonwizard-parameter">
                <div data-bind="dxTextBox: { value: name, placeholder: 'Name', isValid: $parent.editor.editorOptions.isValid($data.name()), validationError: $parent.editor.editorOptions.validationError }"></div>
            </div>
        </div>
        <div class="dx-jsonwizard-parameter-right-container">
            <div class="dx-jsonwizard-parameter">
                <div data-bind="dxTextBox: { value: value, placeholder: 'Value' }"></div>
            </div>
        </div>
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dx-jsonwizard-loadfile-editor">
    <div data-bind="dxFileImagePicker: { value: value, placeHolder: 'File', accept:'.json,.txt' }"></div>
</script>

<script type="text/html" id="dx-jsonwizard-jsonstring-editor">
    <!-- ko if: !aceAvailable -->
    <div class="dxd-border-secondary dxd-back-primary2" style="height: 230px" data-bind="dxTextArea: { value: value, spellcheck: false, isValid: isValid }, dxValidator: { validationRules: jsonStringValidationRules || [] }"></div>
    <!-- /ko -->
    <!-- ko if: aceAvailable -->
    <div class="dxd-wizard-jsoneditor dxd-border-secondary dxd-back-primary2" style="height: 230px" data-bind="dxAceEditor: { value: value, editorContainer: editorContainer, options: aceOptions, additionalOptions: additionalOptions }"></div>
    <!-- /ko -->
...
<script type="text/html" id="dxrd-page-connectionstring">
    <div class="dxrd-wizard-page">
        <div class="dx-wizard-connections dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: connectionStrings, selectedItems: selectedConnectionString, editEnabled: true, editConfig: { selectionEnabled: true }, selectionMode: 'single', activeStateEnabled: false, noDataText: $root.dx.Analytics.Internal.noDataText() }">
                <div data-options="dxTemplate : { name: 'item' }">
...
<script type="text/html" id="dx-wizard-newlayout">
    <div class="dxrd-wizard dx-editors dxd-text-primary" data-bind="dxPopup: {
        ...
        <div class="dxrd-wizard-content">
            ...
            <!-- /ko -->
            <div class="dxrd-wizard-load-panel dxd-text-primary" data-bind="dxLoadPanel: loadPanelViewModel($element)"></div>
        </div>
...
<script type="text/html" id="dx-editor-addons">
    <!-- ko if: visible -->
    <div class="dxrd-editormenu-box dxd-property-grid-menu-box-color dxd-back-contrast" data-bind="dxclick: showPopup, css: editorMenuButtonCss">
...
<script type="text/html" id="dx-combobox-editable">
    <div data-bind="dxSelectBox: getOptions({ items: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', disabled: disabled, placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), acceptCustomValue: true, onCustomItemCreating: function(arg) { return { value: arg.text, displayValue: arg.text }; } })"></div>
</script>
    ...
    <div style="height:100%" class="dxd-text-primary">
        ...
        visible: popupService.visible }">
                <div data-options="dxTemplate: { name: 'content' }">
                    ...
                    <div class="dxrd-editor-menu-item dxd-list-item-back-color dxd-back-highlighted dxd-state-normal" data-bind="dxclick: action">
