...
(function (DevExpress) {
    ...
    (function (Analytics) {
        ...
        (function (Wizard) {
            ...
            function restoreSqlDataSourceFromState(state, requestWrapper) {
                var _a, _b;
            ...
            function restoreJsonDataSourceFromState(state, requestWrapper) {
            ...
            var WrappedWizardPage = (function (_super) {
                ...
                WrappedWizardPage.prototype.initialize = function (state, force) {
                    ...
                    if (!this._isInitialized || force) {
                        ...
                        return this.page.initialize(state);
                    }
                    return $.Deferred().resolve().promise();
                };
            ...
            (function (Internal) {
                ...
                var WizardPageProcessor = (function (_super) {
                    ...
                    function WizardPageProcessor(pageFactory, _loadingState) {
                        var _this = _super.call(this) || this;
                        _this.pageFactory = pageFactory;
                        _this.events = new Analytics.Utils.EventManager();
                        _this._loadingTimeout = null;
            ...
            var PopupWizard = (function (_super) {
                ...
                function PopupWizard(pageFactory, finishCallback) {
                    ...
                    _this.nextButton = {
                        text: Analytics.Utils.getLocalization("Next", "ASPxReportsStringId.SearchDialog_Next"),
                    ...
                    _this.previousButton = {
                        text: Analytics.Utils.getLocalization("Previous", "ASPxReportsStringId.SearchDialog_Previous"),
                        disabled: ko.computed(function () { return _this.isFirstPage(); }),
                        onClick: function () { return _this.previousAction(); }
                    };
                    _this.finishButton = {
                        text: Analytics.Utils.getLocalization("Finish", "ASPxReportsStringId.SearchDialog_Finish"),
            ...
            (function (Internal) {
                ...
                var JsonDataSourceJsonSourcePageUriSettings = (function (_super) {
                    ...
                    function JsonDataSourceJsonSourcePageUriSettings(_requestWrapper) {
                        ...
                        _this.uriValidationRules = [{
                                type: "custom",
                                validationCallback: function (options) {
                                    return _this.isEmpty() || _this._isUriValid();
                                },
                                message: Analytics.Utils.getLocalization('Url is not valid.', "TODO")
                            }];
                        _this.isValid = ko.pureComputed(function () {
                    ...
                    JsonDataSourceJsonSourcePageUriSettings.prototype.getInfo = function () {
                        var _this = this;
                        return [
                            { propertyName: "uriSource", displayName: "Web Service Endpoint (URI)", localizationId: "DataAccessUIStringId.WizardPageChooseJsonSource_SourceType_Uri", defaultVal: "", editor: Analytics.Widgets.editorTemplates.text },
                            {
                                propertyName: "basicHttpAuth", displayName: "Basic HTTP Authentication", info: [
                                    {
                                        propertyName: "userName", displayName: "Username", editor: Analytics.Widgets.editorTemplates.text,
                                        editorOptions: {
                                    ...
                                    { propertyName: "password", displayName: "Password", editor: Analytics.Widgets.editorTemplates.text, editorOptions: { mode: "password" } },
